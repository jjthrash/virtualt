...
class FL_EXPORT My_Text_Display: public Fl_Double_Window {
  public:
    ...
    friend void fl_text_drag_me(int pos, My_Text_Display* d);
  ...
  protected:
    ...
    static void h_scrollbar_cb(Fl_Scrollbar* w, My_Text_Display* d);
    static void v_scrollbar_cb( Fl_Scrollbar* w, My_Text_Display* d);
    ...
    unsigned textcolor_;
	 ...
	 // but are being put here so that future versions of My_Text_Display
